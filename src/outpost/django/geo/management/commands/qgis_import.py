        ...
        for layer in source:
            ...
            for feature in tlayer:
                ...
                obj, created = models.Door.objects.update_or_create(
                    origin=feature.get("id"), defaults=defaults
                )
    ...
    def rooms(self, source):
        ...
        for layer in source:
            ...
            for feature in tlayer:
                ...
                if co_id:
                    template = (
                        "{f.building.campusonline.short}{f.campusonline.short}.{c:03d}"
                    )
                    try:
        ...
        for layer in source:
            ...
            for feature in tlayer:
                ...
                if feature.get("campusonli"):
                    try:
                        defaults["campusonline"] = co.Building.objects.get(
                            short=feature.get("campusonli")
                        )
                    except co.Building.DoesNotExist:
                        defaults["campusonline"] = None
